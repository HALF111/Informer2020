...
class Dataset_Custom(Dataset):
    ...
    def __getitem__(self, index):
        ...
        r_end = r_begin + self.label_len + self.pred_len  # r_end表示decoder预测的结束位置（长为48+24）
        # r_end = s_end + self.pred_len  # 上一句代码的r_end换成本句代码也是一样的）
        ...
        if self.inverse:
            ...
            # 从data_y中取出[r_begin:r_end]部分（一般data_y和data_x是一样的）
            seq_y = self.data_y[r_begin:r_end]
